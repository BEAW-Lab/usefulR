...
set.seed(7)
coor <- data.frame(lon = runif(n = 50, min = -2, max = 0),
                   lat = runif(n = 50, min = 42, max = 43),
...
raster_path_test <- system.file("extdata", "ESA_WorldCover_10m_2021_V200_N42W003_Map.tif", package = "usefulR")
