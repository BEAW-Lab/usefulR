...
devtools::install_github("BEAW-Lab/usefulR")
```
...
download_ESAWC21_raster_vignette(force = TRUE)
# path_to_raster <- './data_vignette/LC_raster_example.tif' # if run from main working directory. Name of the downloaded file
path_to_raster <- '../data_vignette/LC_raster_example.tif' # if the vignette is built. Name of the downloaded file
