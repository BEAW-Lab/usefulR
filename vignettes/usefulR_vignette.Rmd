...
If you want to use CORINE Land Cover instead, provide a CORINE raster and set `dataset = "corine"`.
By default the function will treat artificial-surface classes (111, 112, 121, 122, 123, 124, 131, 132, 133, 141, 142)
as urban land cover:
```{r, include = T, eval = FALSE}
# first download the official CORINE raster using the path to your CLMS service-key JSON file
usefulR::download_corine_raster(
...
extract_land_cover(
  coords = coor |> dplyr::select(lon, lat),
  raster_path = "./data/CLC_CORINE_2018.tif",
  radius_m = 1500,
  dataset = "corine"
)
```
